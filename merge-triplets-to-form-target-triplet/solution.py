...
class Solution:
    ...
    def mergeTriplets(self, triplets: list[list[int]], target: list[int]) -> bool:
        """
        >>> s = Solution()
        >>> s.mergeTriplets(triplets = [[2,5,3],[1,8,4],[1,7,5]], target = [2,7,5])
        True
        >>> s.mergeTriplets(triplets = [[3,4,5],[4,5,6]], target = [3,2,5])
        False
        >>> s.mergeTriplets(triplets = [[2,5,3],[2,3,4],[1,2,5],[5,2,3]], target = [5,5,5])
        True
